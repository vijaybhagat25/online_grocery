...
<?php    
 ...
 include "connection.php" ;
    ...
    $vegitable="Ready-to-eat";
            $insert = mysqli_query($connect,"INSERT INTO `add_product_r` (`p_name`, `p_img`, `p_price`, `p_details`, `p_id`, `category`)
      ...
      if ($insert) {
        ...
        window.location = "../routes_admin/add_ready.html";
        </script>
        ';
       }
        else {
