...
<?php    
 ...
 include "connection.php" ;
    ...
    $vegitable="Meate/Fish";
            $insert = mysqli_query($connect,"INSERT INTO `add_product_m` (`p_name`, `p_img`, `p_price`, `p_details`, `p_id`, `category`)
      ...
      if ($insert) {
        ...
        window.location = "../routes_admin/add_meat.html";
        </script>
        ';
       }
        else {
